...
app_info = {
    ...
    'msg': {'name': '', 'msg': '', 'type':'success', 'display': ''},
}
...
def register(request):
    if request.method == 'POST':
        ...
        try:
            ...
            #messages.success(request, 'Your one time password    was updated.')
...
def add_product(request):
    if request.method=="POST":
        ...
        # app_info['msg_data']['msg'] = f'Your product add  has been successfully '
...
def add_to_cart(request,pk):
    ...
    # app_info['msg_data']['name'] = 'Product add'
    # app_info['msg_data']['msg'] = f'Your pro has been successfully .'
    # app_info['msg_data']['type'] = 'success'
    # app_info['msg_data']['display'] = 'show'
